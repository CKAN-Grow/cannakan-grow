...
-- This migration intentionally does not invent a new trigger function.
-- updated_at trigger handling for public.cstp_requests and public.cstp_tests
-- should be aligned with the existing schema trigger pattern before backend
-- workflows depend on automatic updated_at changes.
--
...
-- ============================================================================
--
-- RLS is intentionally deferred in this migration.
-- Future policies should restrict CSTP management to admins.
-- No public read policies are added for CSTP v1 internal tables.
...
-- ============================================================================
--
-- No public CSTP data should depend on this migration yet.

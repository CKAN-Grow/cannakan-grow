...
--
-- Community Intelligence uses anonymous completed-session aggregates. This
...
-- Snapshot optional. Community Intelligence eligibility begins at Completed.
...
comment on function public.is_community_intelligence_session_eligible(uuid) is
  'Boolean wrapper for Community Intelligence aggregate eligibility. All aggregate consumers should use this lifecycle-backed predicate.';

comment on function public.get_explorer_completed_session_aggregates() is
  'Returns anonymous completed-session Community Intelligence aggregates for Seed Explorer and Source Explorer using the canonical Grow Session lifecycle resolver. Does not expose users, profiles, session titles, dates, notes, images, or private report links.';

comment on function public.get_explorer_completed_session_aggregate_diagnostics() is
  'Admin/service-role diagnostic for Grow Session lifecycle and Community Intelligence aggregate eligibility. Includes session audit details for admins only; public aggregate output remains anonymous.';

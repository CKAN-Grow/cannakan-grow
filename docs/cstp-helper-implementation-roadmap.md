...
1. Lifecycle constants and validation helpers
2. Admin event payload helpers
3. CSTP request helpers
4. CSTP test orchestration helpers
5. CSTP session linkage helpers
6. Internal service composition helpers
7. Admin-only API integration later
8. Admin UI integration later

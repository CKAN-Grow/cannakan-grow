...
const checks = [
  ...
  ["authoritative app-shell generation", serviceWorker.includes("cannakan-grow-shell-v33-profile-hero-metadata") && indexHtml.includes("/profile-hero-catalog-data.js?v=20260720-profile-hero-metadata") && indexHtml.includes("/styles.css?v=20260720-profile-hero-metadata") && indexHtml.includes("/app.js?v=20260720-profile-hero-metadata")],

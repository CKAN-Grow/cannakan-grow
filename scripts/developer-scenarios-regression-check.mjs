...
const checks = [
  ...
  ["authoritative app-shell generation", serviceWorker.includes("cannakan-grow-shell-v27-seed-vault-inventory-hierarchy") && indexHtml.includes("/styles.css?v=20260717-seed-vault-inventory-hierarchy") && indexHtml.includes("/app.js?v=20260717-seed-vault-inventory-hierarchy")],

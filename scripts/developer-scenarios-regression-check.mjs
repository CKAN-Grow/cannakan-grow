...
const checks = [
  ...
  ["authoritative app-shell generation", serviceWorker.includes("cannakan-grow-shell-v28-seed-vault-gallery-cards") && indexHtml.includes("/styles.css?v=20260717-seed-vault-gallery-cards") && indexHtml.includes("/app.js?v=20260717-seed-vault-gallery-cards")],

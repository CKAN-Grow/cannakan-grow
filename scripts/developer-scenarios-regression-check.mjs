...
const checks = [
  ...
  ["authoritative app-shell generation", serviceWorker.includes("cannakan-grow-shell-v29-seed-vault-list-rows") && indexHtml.includes("/styles.css?v=20260717-seed-vault-list-rows") && indexHtml.includes("/app.js?v=20260717-seed-vault-list-rows")],

...
const checks = [
  ...
  ["authoritative app-shell generation", serviceWorker.includes("cannakan-grow-shell-v26-seed-vault-overview-icons") && indexHtml.includes("20260717-seed-vault-overview-icons")],

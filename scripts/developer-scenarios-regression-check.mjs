...
const checks = [
  ...
  ["authoritative app-shell generation", serviceWorker.includes("cannakan-grow-shell-v30-semantic-colors") && indexHtml.includes("/styles.css?v=20260717-semantic-colors") && indexHtml.includes("/app.js?v=20260717-semantic-colors")],

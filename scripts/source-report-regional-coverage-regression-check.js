...
assert(adapter.includes("regionalCoverage: mapRegionalCoverage") && adapter.includes("recentActivity: mapRecentActivity"), "The shared Community adapter must preserve canonical coverage and activity.");
